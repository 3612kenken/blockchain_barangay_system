...
const apiFiscalInfoRoutes = require('./api/apiFiscalInfo');
const apiDemographicInfo = require('./api/apiDemographicInfo');
const apiDemographicInfoRoutes = require('./api/apiDemographicInfo');
...
app.use('/api/manage-fiscal-info', apiFiscalInfoRoutes);
app.use('/api/demographic-info', apiDemographicInfoRoutes);
